...
class RangeMaxExclusiveTest extends PHPUnit_Framework_TestCase {
    ...
    public function testMoreThanMax () {
        $validator = new \Gajus\Vlad\Validator\RangeMaxExclusive(['range' => 10]);
